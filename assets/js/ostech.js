(function ($) {
  ...
  // Date Picker
  if ($(".ostech-datepicker").length) {
    $(".ostech-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accrodion
  if ($(".ostech-accrodion").length) {
    var accrodionGrp = $(".ostech-accrodion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".ostech-accrodion." + accrodionName)
                .find(".accrodion")
                .removeClass("active");
              $(".ostech-accrodion." + accrodionName)
                .find(".accrodion")
  ...
  function thmOwlInit() {
    // owl slider
    let ostechowlCarousel = $(".ostech-owl__carousel");
    ...
    let ostechowlCarouselNav = $(".ostech-owl__carousel--custom-nav");
  ...
  function ostech_stretch() {
    var i = $(window).width();
    $(".row .ostech-stretch-element-inside-column").each(function () {
      var $this = $(this),
